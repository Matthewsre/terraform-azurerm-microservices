...
resource "azurerm_application_insights" "service" {
  ...
  #
  #   tags = {
  #     "hidden-link:/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/${local.resource_group.name}/providers/Microsoft.Web/sites/${local.function_app_name}" = "Resource"
  #   }
